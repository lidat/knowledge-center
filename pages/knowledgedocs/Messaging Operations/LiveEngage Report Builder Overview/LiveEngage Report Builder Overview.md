...
2.	Open the dashboard by clicking the drag down icon ![dragdown](img/Reportbuildericon1.png).
3.	Click the Report Builder icon ![Report builder icon](img/Reportbuildericon2.png) on the left of the screen. A new tab is opened.
4.	Click Shared Reports. Two folders are displayed:
o	LE predefined dashboards: All available predefined LiveEngage dashboards.
o	My Account: Reports that have been designed specifically for your account.
...
Image: Time frame selector main prompt
...
_Note_:
  * _Data will only display for dates chosen within the timeframe selected when you first ran the report (see the Viewing reports)._
